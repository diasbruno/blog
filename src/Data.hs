...
posts =
    [ Post
        ...
        Publish
        ( Map.fromList
            [ ("og:title", "problems when reexporting javascript modules")
            , ("og:image", "/images/reexport.png")
            ]
        )
    , Post
        ...
        Publish
        ( Map.fromList
            [ ("og:title", "working with Sets and some ideas")
            , ("og:image", "/images/working-with-sets-and-more-ideas.png")
            ]
        )
    , Post
        "zippers"
    ...
    , Post
        ...
        Publish
        ( Map.fromList
            [ ("og:title", "even more ideas with types and javascript (equality, ordering and enumeration)")
            , ("og:image", "/images/ideas-with-types.png")
            ]
        )
    , Post
