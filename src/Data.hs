...
oss =
  [
  ("c", [ Oss "slugifier" "https://github.com/diasbruno/slugifier" "c" "a simple slugifier based on unac and pcre2." ]
  ),
  ("common-lisp", [ Oss "cl-bnf" "https://github.com/diasbruno/cl-bnf" "common-lisp" "a bnf parser.",
  ...
  ("elixir", [ Oss "email_ex" "https://github.com/diasbruno/email_ex" "elixir" "Address specification parser (RFC2822)."
             ]
  ),
  ("emacs-lisp", [ Oss "js-eval.el" "https://github.com/diasbruno/js-eval.el" "elisp" "Lets you start a node process in background and start evaluating expressions (like when you are in the scratch buffer in emacs lisp)"
                 ]
  ),
    ("javascript", [ Oss "sbrm" "https://github.com/diasbruno/sbrm" "javascript" "Scoped bound resource management ",
  ...
  ("haskell", [ Oss "language-js" "https://github.com/diasbruno/language-js" "haskell" "Parser for es6 and es7.",
                Oss "hs-unac-bindings" "https://github.com/diasbruno/hs-unac-bindings" "haskell" "Haskell binding for unac(3)."
              ]
  ),
  ("ruby", [ Oss "simple-url" "https://github.com/diasbruno/simple-url" "ruby" "A nice way to work with URLs. "
           ]
  ),
    ("rust", [ Oss "rust_dragino_lgt92_tools" "https://github.com/diasbruno/rust_dragino_lgt92_tools" "rust" "Dragino LGT-92 GPS tools."
             ]
  )]
